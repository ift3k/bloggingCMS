                    ...
                    <div class="blog-details-author-content">
                        ...
                        <div class="socials">
                            ...
                            <a href="{{ $post->user->profile->github }}" class="social__item" target="_blank">
                                <img src="{{ asset('app/svg/github-logo.png') }}" alt="github">
                            </a>

                            <a href="{{ $post->user->profile->stackoverflow }}" class="social__item" target="_blank">
                                <img src="{{ asset('app/svg/stackoverflow.svg') }}" alt="stackoverflow">
                            </a>
