            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        <h3 class="heading-title" >Laravel Business Solutions!</h3>
                        <div class="heading-line">
                            <span class="short-line"></span>
                            <span class="long-line"></span>
                        </div>
                        <p class="heading-text">
                            Guaranteed laravel web application development with
                            well optimized code and free automated and manual security tests!
                            Cause I care about the clients data just as mine.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">Sat-Thu 9am-6pm(GMT +6)</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">Dhaka, Bangladesh</p>
                        </div>
                    </div>
                </div>
            </div>
