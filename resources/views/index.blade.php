                            ...
                            <div class="post__content-info text-center">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="{{ route('catagory.single', ['id' => $first_post->catagory->id ]) }}">{{ $first_post->catagory->name }}</a>
                                        </span>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="#">{{ $second_post->catagory->name }}</a>
                                        </span>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{ route('catagory.single', ['id' => $third_post->catagory->id ]) }}"> {{ $third_post->catagory->name }} </a>
                                        </span> 
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $InfoSec->name }}</h4>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach( $InfoSec->posts()->orderBy('created_at','desc')->take(3)->get() as $post )
